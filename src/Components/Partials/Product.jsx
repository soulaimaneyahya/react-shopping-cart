...
const Product = ({ id, name, description, imgURL, price, created_at, addToCart }) => {

    const [img, setImg] = useState("https://cdn.dribbble.com/users/1187836/screenshots/5935226/3-cart.gif")
        ...
        <div className="col text-center">
            <div className="card h-100">
                ...
                <div className="card-body">
                    ...
                    {auth.isLogin && (<button className="btn btn-dark w-block w-full w-100" onClick={() => addToCart(id)}>
